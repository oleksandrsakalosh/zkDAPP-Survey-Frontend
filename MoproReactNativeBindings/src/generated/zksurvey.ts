...
/* eslint-disable */
// @ts-nocheck
import nativeModule from "./zksurvey-ffi";
...
export function generateCircomProof(zkeyPath: string, circuitInputs: string, proofLib: ProofLib): CircomProofResult /*throws*/ {
    return FfiConverterTypeCircomProofResult.lift(uniffiCaller.rustCallWithError(
            ...
            /*caller:*/ (callStatus) => {
                return nativeModule().ubrn_uniffi_zksurvey_fn_func_generate_circom_proof(
...
export function generateGnarkProof(r1csPath: string, pkPath: string, witnessJson: string): GnarkProofResult /*throws*/ {
    return FfiConverterTypeGnarkProofResult.lift(uniffiCaller.rustCallWithError(
            /*liftError:*/ FfiConverterTypeMoproError.lift.bind(FfiConverterTypeMoproError),
            /*caller:*/ (callStatus) => {
                return nativeModule().ubrn_uniffi_zksurvey_fn_func_generate_gnark_proof(
...
export function generateHalo2Proof(srsPath: string, pkPath: string, circuitInputs: Map<string, Array<string>>): Halo2ProofResult /*throws*/ {
    return FfiConverterTypeHalo2ProofResult.lift(uniffiCaller.rustCallWithError(
            /*liftError:*/ FfiConverterTypeMoproError.lift.bind(FfiConverterTypeMoproError),
            /*caller:*/ (callStatus) => {
                return nativeModule().ubrn_uniffi_zksurvey_fn_func_generate_halo2_proof(
...
export function generateNoirProof(circuitPath: string, srsPath: string | undefined, inputs: Array<string>, onChain: boolean, vk: ArrayBuffer, lowMemoryMode: boolean): ArrayBuffer /*throws*/ {
    return FfiConverterArrayBuffer.lift(uniffiCaller.rustCallWithError(
            /*liftError:*/ FfiConverterTypeMoproError.lift.bind(FfiConverterTypeMoproError),
            /*caller:*/ (callStatus) => {
                return nativeModule().ubrn_uniffi_zksurvey_fn_func_generate_noir_proof(
...
export function getNoirVerificationKey(circuitPath: string, srsPath: string | undefined, onChain: boolean, lowMemoryMode: boolean): ArrayBuffer /*throws*/ {
    return FfiConverterArrayBuffer.lift(uniffiCaller.rustCallWithError(
            /*liftError:*/ FfiConverterTypeMoproError.lift.bind(FfiConverterTypeMoproError),
            /*caller:*/ (callStatus) => {
                return nativeModule().ubrn_uniffi_zksurvey_fn_func_get_noir_verification_key(
        FfiConverterString.lower(circuitPath),
        FfiConverterOptionalString.lower(srsPath),
        FfiConverterBool.lower(onChain),
        FfiConverterBool.lower(lowMemoryMode),
...
export function moproHelloWorld(): string {
    return FfiConverterString.lift(uniffiCaller.rustCall(
            /*caller:*/ (callStatus) => {
                return nativeModule().ubrn_uniffi_zksurvey_fn_func_mopro_hello_world(
                callStatus);
            },
            /*liftString:*/ FfiConverterString.lift.bind(FfiConverterString),
    ));
...
export function verifyCircomProof(zkeyPath: string, proofResult: CircomProofResult, proofLib: ProofLib): boolean /*throws*/ {
    return FfiConverterBool.lift(uniffiCaller.rustCallWithError(
            /*liftError:*/ FfiConverterTypeMoproError.lift.bind(FfiConverterTypeMoproError),
            /*caller:*/ (callStatus) => {
                return nativeModule().ubrn_uniffi_zksurvey_fn_func_verify_circom_proof(
        FfiConverterString.lower(zkeyPath),
...
export function verifyGnarkProof(r1csPath: string, vkPath: string, proofResult: GnarkProofResult): boolean /*throws*/ {
    return FfiConverterBool.lift(uniffiCaller.rustCallWithError(
            /*liftError:*/ FfiConverterTypeMoproError.lift.bind(FfiConverterTypeMoproError),
            /*caller:*/ (callStatus) => {
                return nativeModule().ubrn_uniffi_zksurvey_fn_func_verify_gnark_proof(
        FfiConverterString.lower(r1csPath),
...
export function verifyHalo2Proof(srsPath: string, vkPath: string, proof: ArrayBuffer, publicInput: ArrayBuffer): boolean /*throws*/ {
    return FfiConverterBool.lift(uniffiCaller.rustCallWithError(
            /*liftError:*/ FfiConverterTypeMoproError.lift.bind(FfiConverterTypeMoproError),
            /*caller:*/ (callStatus) => {
                return nativeModule().ubrn_uniffi_zksurvey_fn_func_verify_halo2_proof(
        FfiConverterString.lower(srsPath),
        FfiConverterString.lower(vkPath),
...
export function verifyNoirProof(circuitPath: string, proof: ArrayBuffer, onChain: boolean, vk: ArrayBuffer, lowMemoryMode: boolean): boolean /*throws*/ {
    return FfiConverterBool.lift(uniffiCaller.rustCallWithError(
            /*liftError:*/ FfiConverterTypeMoproError.lift.bind(FfiConverterTypeMoproError),
            /*caller:*/ (callStatus) => {
                return nativeModule().ubrn_uniffi_zksurvey_fn_func_verify_noir_proof(
        FfiConverterString.lower(circuitPath),
        FfiConverterArrayBuffer.lower(proof),
        FfiConverterBool.lower(onChain),
        FfiConverterArrayBuffer.lower(vk),
...
function uniffiEnsureInitialized() {
    ...
    const scaffoldingContractVersion = nativeModule().ubrn_ffi_zksurvey_uniffi_contract_version();
    if (bindingsContractVersion !== scaffoldingContractVersion) {
        throw new UniffiInternalError.ContractVersionMismatch(scaffoldingContractVersion, bindingsContractVersion);
    }
    if (nativeModule().ubrn_uniffi_zksurvey_checksum_func_generate_circom_proof() !== 40167) {
        throw new UniffiInternalError.ApiChecksumMismatch("uniffi_zksurvey_checksum_func_generate_circom_proof");
    }
    if (nativeModule().ubrn_uniffi_zksurvey_checksum_func_generate_gnark_proof() !== 54396) {
        throw new UniffiInternalError.ApiChecksumMismatch("uniffi_zksurvey_checksum_func_generate_gnark_proof");
    }
    if (nativeModule().ubrn_uniffi_zksurvey_checksum_func_generate_halo2_proof() !== 14371) {
        throw new UniffiInternalError.ApiChecksumMismatch("uniffi_zksurvey_checksum_func_generate_halo2_proof");
    }
    if (nativeModule().ubrn_uniffi_zksurvey_checksum_func_generate_noir_proof() !== 42038) {
        throw new UniffiInternalError.ApiChecksumMismatch("uniffi_zksurvey_checksum_func_generate_noir_proof");
    }
    if (nativeModule().ubrn_uniffi_zksurvey_checksum_func_get_noir_verification_key() !== 57853) {
        throw new UniffiInternalError.ApiChecksumMismatch("uniffi_zksurvey_checksum_func_get_noir_verification_key");
    }
    if (nativeModule().ubrn_uniffi_zksurvey_checksum_func_mopro_hello_world() !== 27196) {
        throw new UniffiInternalError.ApiChecksumMismatch("uniffi_zksurvey_checksum_func_mopro_hello_world");
    }
    if (nativeModule().ubrn_uniffi_zksurvey_checksum_func_verify_circom_proof() !== 24175) {
        throw new UniffiInternalError.ApiChecksumMismatch("uniffi_zksurvey_checksum_func_verify_circom_proof");
    }
    if (nativeModule().ubrn_uniffi_zksurvey_checksum_func_verify_gnark_proof() !== 19625) {
        throw new UniffiInternalError.ApiChecksumMismatch("uniffi_zksurvey_checksum_func_verify_gnark_proof");
    }
    if (nativeModule().ubrn_uniffi_zksurvey_checksum_func_verify_halo2_proof() !== 30832) {
        throw new UniffiInternalError.ApiChecksumMismatch("uniffi_zksurvey_checksum_func_verify_halo2_proof");
    }
    if (nativeModule().ubrn_uniffi_zksurvey_checksum_func_verify_noir_proof() !== 29496) {
        throw new UniffiInternalError.ApiChecksumMismatch("uniffi_zksurvey_checksum_func_verify_noir_proof");
    }
