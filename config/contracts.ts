...
export const SURVEY_MANAGER_CONTRACT_ADDRESS =
  ...
  "0xA7619540B6DCF91A16C3Efc73Be76Bb3eeB66e22";
...
export const SURVEY_MANAGER_DEPLOYMENT_BLOCK = Number(
  process.env.EXPO_PUBLIC_SURVEY_MANAGER_DEPLOYMENT_BLOCK ?? 10722443
);
...
export const SURVEY_MANAGER_ABI = [
  ...
  "function registerForElection(uint256 electionId,uint256[2] pi_a,uint256[2][2] pi_b,uint256[2] pi_c,uint256[2] pubInputs)",
  ...
  "function verifyProofView(uint256[2] pi_a,uint256[2][2] pi_b,uint256[2] pi_c,uint256[2] pubInputs) view returns (bool)",
